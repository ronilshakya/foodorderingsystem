      ...
      <div className='grid grid-rows-2 grid-cols-1 lg:grid-cols-2 lg:grid-rows-1 items-center'>
        ...
        <div>
          <form action="" className='flex flex-col gap-4 bg-white'>
            ...
            <textarea onChange={(e)=>setMessage(e.target.value)} className="border border-neutral-400 p-2 rounded-md text-neutral-600 focus:border-orange-400 focus:outline-none" id="" cols="30" rows="8" placeholder='Enter your message'></textarea>
