  ...
  return (
    <div id='offers'>
        ...
        <div id='10%Offer'className='my-5'>
          <div className='flex items-center sm:flex-row flex-col gap-8 border border-orange-500 rounded-2xl overflow-hidden'>
            <img src={img1} className='sm:w-64 w-full' alt="" />
